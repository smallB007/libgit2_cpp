...
Git_Branch::Git_Branch(git_reference* c_git_branch_ref, const branch_name_t& branch_name, bool force):Provider(c_git_branch_ref, git_reference_free)
{
...
{
	const NMS::vector<NMS::string> files_to_commit;
	const NMS::string msg;
