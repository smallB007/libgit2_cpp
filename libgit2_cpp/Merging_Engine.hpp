...
class Merging_Engine : public Parent_Provider
{
public:
	...
	static shared_ptr_t<Git_Object_ID> Merging_Engine::merge_base(const Git_Object_ID& first, const Git_Object_ID& second);
	static vector_t<shared_ptr_t<Git_Object_ID>> Merging_Engine::merge_bases(const Git_Object_ID & first, const Git_Object_ID & second);
