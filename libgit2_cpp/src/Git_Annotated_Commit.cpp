...
shared_ptr_t<Git_Annotated_Commit> Git_Annotated_Commit::commit_from_fetchhead(const string_t& branchName, const string_t& remoteUrl,const Git_Object_ID& objectID) const
{
