...
void Git_Config::add_file_on_disk(const string_t& path, const Git_Config_Level& config_level, bool force)
{
...
string_t Git_Config::find_path_helper_() const
{
...
string_t Git_Config::find_global_path() const
{
	return find_path_helper_<GLOBAL>();
}

string_t Git_Config::find_program_data_path() const
{
	return find_path_helper_<PROGRAM>();
}

string_t Git_Config::find_system_path() const
{
...
string_t Git_Config::get_path(const string_t & varName) const
{
...
shared_ptr_t<Git_Config> Git_Config::open_on_disk(const string_t& configOnHDD) const
{
	git_config* c_git_config_out;
...
string_t Git_Config::parse_path(const string_t & path) const
{
	//size_t file_path_length{ 256 };
	//Scoped_Deleter_Buf<git_buf> c_git_buf_out(file_path_length);
	git_buf c_git_buf;
