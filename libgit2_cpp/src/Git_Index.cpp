...
void Git_Index::add_bypath(const string_t & path)
{
...
vector_t<shared_ptr_t<Git_Index_Entry>> Git_Index::conflict_get(const string_t& path) 
{
...
void Git_Index::conflict_remove(const string_t& path)
{
...
size_t Git_Index::find(const string_t & path) const
{
	size_t inx;
...
shared_ptr_t<Git_Index_Entry> Git_Index::get_by_path(const string_t & path, const int stage) const
{
...
void Git_Index::remove_directory(const string_t & dir, const int stage) const
{
